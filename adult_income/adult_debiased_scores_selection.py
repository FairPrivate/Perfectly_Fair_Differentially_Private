...
df.to_csv('adult_wb_without_noise_debiased_vs_original_multiple_selection.csv')
print('hi')
...
equal_opportunity_original_1.to_csv('adult_wb_equal_opportunity_original_multiple_selection_1.csv')
...
accuracy_in_all_iterations_original_1.to_csv(
    'adult_wb_accuracy_in_all_iterations_original_multiple_selection_1.csv')
accuracy_in_a_iterations_original_1.to_csv(
    'adult_wb_accuracy_in_a_iterations_original_multiple_selection_1.csv')
accuracy_in_b_iterations_original_1.to_csv(
    'adult_wb_accuracy_in_b_iterations_original_multiple_selection_1.csv')
...
equal_opportunity_1.to_csv('adult_wb_equal_opportunity_debiased_multiple_selection_1.csv')
accuracy_in_all_1.to_csv('adult_wb_accuracy_debiased_multiple_selection_1.csv')
accuracy_in_all_iterations_1.to_csv(
    'adult_wb_accuracy_in_all_iterations_debiased_multiple_selection_1.csv')
accuracy_in_a_iterations_1.to_csv(
    'adult_wb_accuracy_in_a_iterations_debiased_multiple_selection_1.csv')
accuracy_in_b_iterations_1.to_csv(
    'adult_wb_accuracy_in_b_iterations_debiased_multiple_selection_1.csv')
