...
epsilon1_s = [0.01, 0.01, 0.01, 0.0102, 0.0105, 0.011, 0.015, 0.02]
epsilon2_s = [0.0105, 0.0102, 0.01, 0.01, 0.01, 0.01, 0.01, 0.01]

names =["1_105", "1_102", "1_1", "102_1", "105_1", "11_1", "15_1", "2_1"]
...
for ratio in range(len(names)):
    ...
    prob_a_1.to_csv('wha_'+str(names[ratio])+'_prob_a_1.csv')
    prob_b_1.to_csv('wha_'+str(names[ratio])+'_prob_b_1.csv')
    equal_opportunity_1.to_csv('wha_'+str(names[ratio])+'_equal_opportunity_1.csv')
    accuracy_in_all_1.to_csv('wha_'+str(names[ratio])+'_accuracy_in_all_1.csv')
    accuracy_in_all_iterations_1.to_csv('wha_'+str(names[ratio])+'_accuracy_in_all_iterations_1.csv')
    accuracy_in_a_iterations_1.to_csv('wha_'+str(names[ratio])+'_accuracy_in_a_iterations_1.csv')
    accuracy_in_b_iterations_1.to_csv('wha_'+str(names[ratio])+'_accuracy_in_b_iterations_1.csv')
    
    prob_a_2.to_csv('wha_'+str(names[ratio])+'_prob_a_2.csv')
    prob_b_2.to_csv('wha_'+str(names[ratio])+'_prob_b_2.csv')
    equal_opportunity_2.to_csv('wha_'+str(names[ratio])+'_equal_opportunity_2.csv')
    accuracy_in_all_2.to_csv('wha_'+str(names[ratio])+'_accuracy_in_all_2.csv')
    accuracy_in_all_iterations_2.to_csv('wha_'+str(names[ratio])+'_accuracy_in_all_iterations_2.csv')
    accuracy_in_a_iterations_2.to_csv('wha_'+str(names[ratio])+'_accuracy_in_a_iterations_2.csv')
    accuracy_in_b_iterations_2.to_csv('wha_'+str(names[ratio])+'_accuracy_in_b_iterations_2.csv')
    
    prob_a_3.to_csv('wha_'+str(names[ratio])+'_prob_a_3.csv')
    prob_b_3.to_csv('wha_'+str(names[ratio])+'_prob_b_3.csv')
    equal_opportunity_3.to_csv('wha_'+str(names[ratio])+'_equal_opportunity_3.csv')
    accuracy_in_all_3.to_csv('wha_'+str(names[ratio])+'_accuracy_in_all_3.csv')
    accuracy_in_all_iterations_3.to_csv('wha_'+str(names[ratio])+'_accuracy_in_all_iterations_3.csv')
    accuracy_in_a_iterations_3.to_csv('wha_'+str(names[ratio])+'_accuracy_in_a_iterations_3.csv')
    accuracy_in_b_iterations_3.to_csv('wha_'+str(names[ratio])+'_accuracy_in_b_iterations_3.csv')
    
    prob_a_4.to_csv('wha_'+str(names[ratio])+'_prob_a_4.csv')
    prob_b_4.to_csv('wha_'+str(names[ratio])+'_prob_b_4.csv')
    equal_opportunity_4.to_csv('wha_'+str(names[ratio])+'_equal_opportunity_4.csv')
    accuracy_in_all_4.to_csv('wha_'+str(names[ratio])+'_accuracy_in_all_4.csv')
    accuracy_in_all_iterations_4.to_csv('wha_'+str(names[ratio])+'_accuracy_in_all_iterations_4.csv')
    accuracy_in_a_iterations_4.to_csv('wha_'+str(names[ratio])+'_accuracy_in_a_iterations_4.csv')
    accuracy_in_b_iterations_4.to_csv('wha_'+str(names[ratio])+'_accuracy_in_b_iterations_4.csv')
