...
rho = CDF['Score']/100
epsilons = [0.1*x for x in range(201)]
epsilons[0] = 0.0001
sensitivity = 1

db = pd.read_csv('wha_generated_samples_corrected.csv')
...
debiased_model_01 = AdversarialDebiasing(privileged_groups = privileged_groups, unprivileged_groups = unprivileged_groups,
                          scope_name='debiased_classifier', debias=True, sess=sess, num_epochs=50, batch_size=20,
...
df.to_csv('wha_without_noise_debiased_vs_original_multiple_selection.csv')
print('hi')
...
prob_a_original_1.to_csv('wha_prob_a_original_multiple_selection_1.csv')
prob_b_original_1.to_csv('wha_prob_b_original_multiple_selection_1.csv')
equal_opportunity_original_1.to_csv('wha_equal_opportunity_original_multiple_selection_1.csv')
accuracy_in_all_original_1.to_csv('wha_accuracy_in_all_original_multiple_selection_1.csv')
accuracy_in_all_iterations_original_1.to_csv(
    'wha_accuracy_in_all_iterations_original_multiple_selection_1.csv')
accuracy_in_a_iterations_original_1.to_csv(
    'wha_accuracy_in_a_iterations_original_multiple_selection_1.csv')
accuracy_in_b_iterations_original_1.to_csv(
    'wha_accuracy_in_b_iterations_original_multiple_selection_1.csv')
...
prob_a_original_2.to_csv('wha_prob_a_original_multiple_selection_2.csv')
prob_b_original_2.to_csv('wha_prob_b_original_multiple_selection_2.csv')
equal_opportunity_original_2.to_csv('wha_equal_opportunity_original_multiple_selection_2.csv')
accuracy_in_all_original_2.to_csv('wha_accuracy_in_all_original_multiple_selection_2.csv')
accuracy_in_all_iterations_original_2.to_csv(
    'wha_accuracy_in_all_iterations_original_multiple_selection_2.csv')
accuracy_in_a_iterations_original_2.to_csv(
    'wha_accuracy_in_a_iterations_original_multiple_selection_2.csv')
accuracy_in_b_iterations_original_2.to_csv(
    'wha_accuracy_in_b_iterations_original_multiple_selection_2.csv')
...
prob_a_original_3.to_csv('wha_prob_a_original_multiple_selection_3.csv')
prob_b_original_3.to_csv('wha_prob_b_original_multiple_selection_3.csv')
equal_opportunity_original_3.to_csv('wha_equal_opportunity_original_multiple_selection_3.csv')
accuracy_in_all_original_3.to_csv('wha_accuracy_in_all_original_multiple_selection_3.csv')
accuracy_in_all_iterations_original_3.to_csv(
    'wha_accuracy_in_all_iterations_original_multiple_selection_3.csv')
accuracy_in_a_iterations_original_3.to_csv(
    'wha_accuracy_in_a_iterations_original_multiple_selection_3.csv')
accuracy_in_b_iterations_original_3.to_csv(
    'wha_accuracy_in_b_iterations_original_multiple_selection_3.csv')
...
prob_a_original_4.to_csv('wha_prob_a_original_multiple_selection_4.csv')
prob_b_original_4.to_csv('wha_prob_b_original_multiple_selection_4.csv')
equal_opportunity_original_4.to_csv('wha_equal_opportunity_original_multiple_selection_4.csv')
accuracy_in_all_original_4.to_csv('wha_accuracy_in_all_original_multiple_selection_4.csv')
accuracy_in_all_iterations_original_4.to_csv(
    'wha_accuracy_in_all_iterations_original_multiple_selection_4.csv')
accuracy_in_a_iterations_original_4.to_csv(
    'wha_accuracy_in_a_iterations_original_multiple_selection_4.csv')
accuracy_in_b_iterations_original_4.to_csv(
    'wha_accuracy_in_b_iterations_original_multiple_selection_4.csv')
...
prob_a_1.to_csv('wha_prob_a_debiased_multiple_selection_1.csv')
prob_b_1.to_csv('wha_prob_b_debiased_multiple_selection_1.csv')
equal_opportunity_1.to_csv('wha_equal_opportunity_debiased_multiple_selection_1.csv')
accuracy_in_all_1.to_csv('wha_accuracy_debiased_multiple_selection_1.csv')
accuracy_in_all_iterations_1.to_csv(
    'wha_accuracy_in_all_iterations_debiased_multiple_selection_1.csv')
accuracy_in_a_iterations_1.to_csv(
    'wha_accuracy_in_a_iterations_debiased_multiple_selection_1.csv')
accuracy_in_b_iterations_1.to_csv(
    'wha_accuracy_in_b_iterations_debiased_multiple_selection_1.csv')
...
prob_a_2.to_csv('wha_prob_a_debiased_multiple_selection_2.csv')
prob_b_2.to_csv('wha_prob_b_debiased_multiple_selection_2.csv')
equal_opportunity_2.to_csv('wha_equal_opportunity_debiased_multiple_selection_2.csv')
accuracy_in_all_2.to_csv('wha_accuracy_debiased_multiple_selection_2.csv')
accuracy_in_all_iterations_2.to_csv(
    'wha_accuracy_in_all_iterations_debiased_multiple_selection_2.csv')
accuracy_in_a_iterations_2.to_csv(
    'wha_accuracy_in_a_iterations_debiased_multiple_selection_2.csv')
accuracy_in_b_iterations_2.to_csv(
    'wha_accuracy_in_b_iterations_debiased_multiple_selection_2.csv')
...
prob_a_3.to_csv('wha_prob_a_debiased_multiple_selection_3.csv')
prob_b_3.to_csv('wha_prob_b_debiased_multiple_selection_3.csv')
equal_opportunity_3.to_csv('wha_equal_opportunity_debiased_multiple_selection_3.csv')
accuracy_in_all_3.to_csv('wha_accuracy_debiased_multiple_selection_3.csv')
accuracy_in_all_iterations_3.to_csv(
    'wha_accuracy_in_all_iterations_debiased_multiple_selection_3.csv')
accuracy_in_a_iterations_3.to_csv(
    'wha_accuracy_in_a_iterations_debiased_multiple_selection_3.csv')
accuracy_in_b_iterations_3.to_csv(
    'wha_accuracy_in_b_iterations_debiased_multiple_selection_3.csv')
...
prob_a_4.to_csv('wha_prob_a_debiased_multiple_selection_4.csv')
prob_b_4.to_csv('wha_prob_b_debiased_multiple_selection_4.csv')
equal_opportunity_4.to_csv('wha_equal_opportunity_debiased_multiple_selection_4.csv')
accuracy_in_all_4.to_csv('wha_accuracy_debiased_multiple_selection_4.csv')
accuracy_in_all_iterations_4.to_csv(
    'wha_accuracy_in_all_iterations_debiased_multiple_selection_4.csv')
accuracy_in_a_iterations_4.to_csv(
    'wha_accuracy_in_a_iterations_debiased_multiple_selection_4.csv')
accuracy_in_b_iterations_4.to_csv(
    'wha_accuracy_in_b_iterations_debiased_multiple_selection_4.csv')
