...
names = ['wb_prob_a', 'wb_prob_b', 'wb_equal_opportunity', 'wb_accuracy_in_all_iterations', 'wb_accuracy_in_all',
         'wb_a_accuracy_in_iterations', 'wb_b_accuracy_in_iterations']


wb_file_name_1_105 = ['wb_1_105_prob_a', 'wb_1_105_prob_b', 'wb_1_105_equal_opportunity', 'wb_1_105_accuracy_in_all',
                      'wb_1_105_accuracy_in_all_iterations', 'wb_1_105_accuracy_in_a_iterations',
                      'wb_1_105_accuracy_in_b_iterations']

wb_file_name_1_1 = ['wb_1_1_prob_a', 'wb_1_1_prob_b', 'wb_1_1_equal_opportunity', 'wb_1_1_accuracy_in_all',
                    'wb_1_1_accuracy_in_all_iterations', 'wb_1_1_accuracy_in_a_iterations',
                    'wb_1_1_accuracy_in_b_iterations']

wb_file_name_105_1 = ['wb_105_1_prob_a', 'wb_105_1_prob_b', 'wb_105_1_equal_opportunity', 'wb_105_1_accuracy_in_all',
                      'wb_105_1_accuracy_in_all_iterations', 'wb_105_1_accuracy_in_a_iterations',
                      'wb_105_1_accuracy_in_b_iterations']

wb_file_name_11_1 = ['wb_11_1_prob_a', 'wb_11_1_prob_b', 'wb_11_1_equal_opportunity', 'wb_11_1_accuracy_in_all',
                     'wb_11_1_accuracy_in_all_iterations', 'wb_11_1_accuracy_in_a_iterations',
                     'wb_11_1_accuracy_in_b_iterations']

wb_file_name_15_1 = ['wb_15_1_prob_a', 'wb_15_1_prob_b', 'wb_15_1_equal_opportunity', 'wb_15_1_accuracy_in_all',
                     'wb_15_1_accuracy_in_all_iterations', 'wb_15_1_accuracy_in_a_iterations',
                     'wb_15_1_accuracy_in_b_iterations']

wb_file_name_2_1 = ['wb_2_1_prob_a', 'wb_2_1_prob_b', 'wb_2_1_equal_opportunity', 'wb_2_1_accuracy_in_all',
                    'wb_2_1_accuracy_in_all_iterations', 'wb_2_1_accuracy_in_a_iterations',
                    'wb_2_1_accuracy_in_b_iterations']

wb_file_name_3_1 = ['wb_3_1_prob_a', 'wb_3_1_prob_b', 'wb_3_1_equal_opportunity', 'wb_3_1_accuracy_in_all',
                    'wb_3_1_accuracy_in_all_iterations', 'wb_3_1_accuracy_in_a_iterations',
                    'wb_3_1_accuracy_in_b_iterations']

wb_file_name_4_1 = ['wb_4_1_prob_a', 'wb_4_1_prob_b', 'wb_4_1_equal_opportunity', 'wb_4_1_accuracy_in_all',
                    'wb_4_1_accuracy_in_all_iterations', 'wb_4_1_accuracy_in_a_iterations',
                    'wb_4_1_accuracy_in_b_iterations']

same_noise_wb_file_name = ['wb_same_prob_a', 'wb_same_prob_b', 'wb_same_equal_opportunity', 'wb_same_accuracy_in_all',
                           'wb_same_accuracy_in_all_iterations', 'wb_same_accuracy_in_a_iterations',
                           'wb_same_accuracy_in_b_iterations']

debiased = ['wb_prob_a_debiased_multiple_selection', 'wb_prob_b_debiased_multiple_selection',
                            'wb_equal_opportunity_debiased_multiple_selection',
                            'wb_accuracy_debiased_multiple_selection',
                            'wb_accuracy_in_all_iterations_debiased_multiple_selection',
                            'wb_accuracy_in_a_iterations_debiased_multiple_selection',
                            'wb_accuracy_in_b_iterations_debiased_multiple_selection']

expeiments = [same_noise_wb_file_name, wb_file_name_1_105, wb_file_name_1_1, wb_file_name_105_1, wb_file_name_11_1,
              wb_file_name_15_1, wb_file_name_2_1, wb_file_name_3_1, wb_file_name_4_1, debiased]
proportions = [['same'], [1, 1.05], [1, 1], [1.05, 1], [1.1, 1], [1.5, 1], [2, 1], [3, 1], [4, 1]]
for name_index in range(len(wb_file_name_1_1)):
    ...
    data4_1 = data4_1[:1905]
    data4_2 = data4_2[:1905]
    data4_3 = data4_3[:1905]
    data4_4 = data4_4[:1905]
    epsilons4 = epsilons4[:1905]

    data5_1 = data5_1[:1819]
    data5_2 = data5_2[:1819]
    data5_3 = data5_3[:1819]
    data5_4 = data5_4[:1819]
    epsilons5 = epsilons5[:1819]
    ...
    ax1.plot(xp1, p1_1(xp1), '-', color='lime', label=r'($\alpha$=same)')
    ax2.plot(xp1, p1_2(xp1), '-', color='lime', label=r'($\alpha$=same)')
    ax3.plot(xp1, p1_3(xp1), '-', color='lime', label=r'($\alpha$=same)')
    ax4.plot(xp1, p1_4(xp1), '-', color='lime', label=r'($\alpha$=same)')
    ...
    ax1.plot(xp4, p4_1(xp4), '-', color='cornflowerblue', label= r'($\alpha$=$\frac{'+str(proportions[3][0])+'}{'+str(proportions[3][1])+'}$)')
    ax2.plot(xp4, p4_2(xp4), '-', color='cornflowerblue', label= r'($\alpha$=$\frac{'+str(proportions[3][0])+'}{'+str(proportions[3][1])+'}$)')
    ax3.plot(xp4, p4_3(xp4), '-', color='cornflowerblue', label= r'($\alpha$=$\frac{'+str(proportions[3][0])+'}{'+str(proportions[3][1])+'}$)')
    ax4.plot(xp4, p4_4(xp4), '-', color='cornflowerblue', label= r'($\alpha$=$\frac{'+str(proportions[3][0])+'}{'+str(proportions[3][1])+'}$)')
    ...
    plt.savefig(str(names[name_index]) + '_multiple_selection_plus_debiased_after_neurips.pdf', dpi=300)
    plt.show()
    plt.clf()
    print('hi')
