...
Y0b = 0.33655060999999405 # \Pr[Y=0|A='Black']
Y0a = 0.2413262699999973 # \Pr[Y=0|A='White']
alpha_a = 0.8793309517363427 # \Pr[A='White'] = 1 - \Pr[A='Black']

P00 = pd.read_csv('P00_a0.csv') # \Pr[R=\rho|A='White', Y=0]
P01 = pd.read_csv('P01_a1.csv') # \Pr[R=\rho|A='White', Y=1]
...
db.to_csv('checking_wb_generated_samples_corrected.csv')
