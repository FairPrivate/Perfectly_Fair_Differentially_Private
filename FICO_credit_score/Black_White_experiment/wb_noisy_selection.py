...
for ratio in range(len(names)):
    ...
    prob_a.to_csv('wb_'+str(names[ratio])+'_prob_a.csv')
    prob_b.to_csv('wb_'+str(names[ratio])+'_prob_b.csv')
    equal_opportunity.to_csv('wb_'+str(names[ratio])+'_equal_opportunity.csv')
    accuracy_in_all.to_csv('wb_'+str(names[ratio])+'_accuracy_in_all.csv')
    accuracy_in_a.to_csv('wb_'+str(names[ratio])+'_accuracy_in_a.csv')
    accuracy_in_b.to_csv('wb_'+str(names[ratio])+'_accuracy_in_b.csv')
    accuracy_in_all_iterations.to_csv('wb_'+str(names[ratio])+'_accuracy_in_all_iterations.csv')
    accuracy_in_a_iterations.to_csv('wb_'+str(names[ratio])+'_accuracy_in_a_iterations.csv')
    accuracy_in_b_iterations.to_csv('wb_'+str(names[ratio])+'_accuracy_in_b_iterations.csv')
